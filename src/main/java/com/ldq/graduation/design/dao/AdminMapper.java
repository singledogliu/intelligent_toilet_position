...
public interface AdminMapper {
	 ...
	 * @return 受影响的条数
	 */
	int updateButAccount(@Param("oldAdminAccount") String oldAdminAccount, @Param("adminName") String adminName, @Param("adminPassword") String adminPassword, @Param("adminPhone") String adminPhone);
	 ...
	 * @return 受影响的条数
	 */
	int updatePhone(@Param("oldAdminAccount") String oldAdminAccount, @Param("adminPhone") String adminPhone);
	 ...
	 * @return 受影响的条数
	 */
	int updateAccount(@Param("oldAdminAccount") String oldAdminAccount, @Param("adminAccount") String adminAccount);
}
